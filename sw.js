const CACHE='txa-v20-focus-compact-v3-short-layout';
const ASSETS=['./','./index.html','./styles.css','./manifest.webmanifest','./assets/icons/icon.svg','./js/app.js','./js/db.js','./js/engine.js','./js/settings.js','./js/export.js'];
